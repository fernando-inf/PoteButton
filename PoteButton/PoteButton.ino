...
//Potenciometro en Pulsador Digital= 
//Al apretar y soltar rápido el Valor de la Variable (Velocity) se incrementa.
...
void setup()
{
  ...
  for (int i = 3; i <= 6; i++) {
    pinMode(i, OUTPUT); //PINES DIGITALES para LEDs: D3 a D6
  }
